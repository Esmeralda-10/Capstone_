...
// Handle AJAX chemical request (for datalist)
...
<div class="dashboard-container">
    ...
    <div class="form-card">
        ...
        <form method="POST" action="edit_inventory.php?id=<?= $id ?>">
            ...
            <!-- Chemical with datalist -->
            <div class="form-group">
                <label for="active_ingredient" class="form-label">Chemical</label>
...
$(document).ready(function() {
    // Load chemicals when service is selected
